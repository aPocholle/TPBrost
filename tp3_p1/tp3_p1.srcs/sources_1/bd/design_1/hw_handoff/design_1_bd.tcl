...
# module references:
# debounce, ov7670_capture, ov7670_controller, i2c_sender_adv7511
...
proc create_root_design { parentCell } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net video_in_1 [get_bd_intf_pins im_load_0/video] [get_bd_intf_pins video_ctrl/video_in]
  ...
  connect_bd_net -net clk_wiz_0_clk_100 [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins clk_wiz_0/clk_100] [get_bd_pins im_load_0/ap_clk] [get_bd_pins video_ctrl/wr_clk]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins im_load_0/ap_rst_n] [get_bd_pins im_load_0/ap_start] [get_bd_pins xlconstant_2/dout]
