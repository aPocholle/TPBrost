...
// ==============================================================
#ifndef __c_grav_udiv_32ns_bkb__HH__
#define __c_grav_udiv_32ns_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(c_grav_udiv_32ns_bkb) {
    ...
    SC_CTOR(c_grav_udiv_32ns_bkb):  ACMP_udiv_seq_U ("ACMP_udiv_seq_U") {
