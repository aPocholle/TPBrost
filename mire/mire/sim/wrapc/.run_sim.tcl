...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mire.autotvin.dat"
	set constFileTvOut       "mire.autotvout.dat"
	set constFileHdlTvIn     "mire.autohdltvin.dat"
	set constFileHdlTvOut    "mire.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
