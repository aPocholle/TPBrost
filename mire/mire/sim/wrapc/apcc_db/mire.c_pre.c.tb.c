...
printf("\n  %%. = select i1 %%5, i8 0, i8 -1, !dbg !3 for 0x%I64xth hint within @mire  --> \n", ++aesl_llvm_cbe__2e__count);
  llvm_cbe__2e_ = (unsigned char )(((((signed int )llvm_cbe_storemerge14) < ((signed int )426u))) ? ((unsigned char )((unsigned char )0)) : ((unsigned char )((unsigned char )-1)));
if (AESL_DEBUG_TRACE)
printf("\n. = 0x%X\n", llvm_cbe__2e_);
if (AESL_DEBUG_TRACE)
printf("\n  %%.3 = sext i1 %%5 to i8, !dbg !3 for 0x%I64xth hint within @mire  --> \n", ++aesl_llvm_cbe__2e_3_count);
  llvm_cbe__2e_3 = (unsigned char )(( char )(0-(((signed int )llvm_cbe_storemerge14) < ((signed int )426u))));
if (AESL_DEBUG_TRACE)
printf("\n.3 = 0x%X\n", llvm_cbe__2e_3);
