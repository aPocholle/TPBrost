...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mire.autotvout_p_red.dat"
         "c.mire.autotvout_p_green.dat"
         "c.mire.autotvout_p_blue.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mire.autotvout_p_red.dat"
         "rtl.mire.autotvout_p_green.dat"
         "rtl.mire.autotvout_p_blue.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
