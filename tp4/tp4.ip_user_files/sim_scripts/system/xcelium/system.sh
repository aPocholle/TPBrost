...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"../../../../tp4.srcs/sources_1/bd/system/ipshared/4fba" \
       +incdir+"../../../../tp4.srcs/sources_1/bd/system/ipshared/1b7e/hdl/verilog" \
       +incdir+"../../../../tp4.srcs/sources_1/bd/system/ipshared/122e/hdl/verilog" \
       +incdir+"../../../../tp4.srcs/sources_1/bd/system/ipshared/ec67/hdl"
}
