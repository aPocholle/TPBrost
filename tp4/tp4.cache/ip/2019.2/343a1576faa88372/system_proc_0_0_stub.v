...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(ap_clk, ap_rst_n, m_axi_port_r_AWADDR, 
  m_axi_port_r_AWLEN, m_axi_port_r_AWSIZE, m_axi_port_r_AWBURST, m_axi_port_r_AWLOCK, 
  m_axi_port_r_AWREGION, m_axi_port_r_AWCACHE, m_axi_port_r_AWPROT, m_axi_port_r_AWQOS, 
  m_axi_port_r_AWVALID, m_axi_port_r_AWREADY, m_axi_port_r_WDATA, m_axi_port_r_WSTRB, 
  m_axi_port_r_WLAST, m_axi_port_r_WVALID, m_axi_port_r_WREADY, m_axi_port_r_BRESP, 
  m_axi_port_r_BVALID, m_axi_port_r_BREADY, m_axi_port_r_ARADDR, m_axi_port_r_ARLEN, 
  m_axi_port_r_ARSIZE, m_axi_port_r_ARBURST, m_axi_port_r_ARLOCK, m_axi_port_r_ARREGION, 
  m_axi_port_r_ARCACHE, m_axi_port_r_ARPROT, m_axi_port_r_ARQOS, m_axi_port_r_ARVALID, 
  m_axi_port_r_ARREADY, m_axi_port_r_RDATA, m_axi_port_r_RRESP, m_axi_port_r_RLAST, 
  m_axi_port_r_RVALID, m_axi_port_r_RREADY)
/* synthesis syn_black_box black_box_pad_pin="ap_clk,ap_rst_n,m_axi_port_r_AWADDR[31:0],m_axi_port_r_AWLEN[7:0],m_axi_port_r_AWSIZE[2:0],m_axi_port_r_AWBURST[1:0],m_axi_port_r_AWLOCK[1:0],m_axi_port_r_AWREGION[3:0],m_axi_port_r_AWCACHE[3:0],m_axi_port_r_AWPROT[2:0],m_axi_port_r_AWQOS[3:0],m_axi_port_r_AWVALID,m_axi_port_r_AWREADY,m_axi_port_r_WDATA[31:0],m_axi_port_r_WSTRB[3:0],m_axi_port_r_WLAST,m_axi_port_r_WVALID,m_axi_port_r_WREADY,m_axi_port_r_BRESP[1:0],m_axi_port_r_BVALID,m_axi_port_r_BREADY,m_axi_port_r_ARADDR[31:0],m_axi_port_r_ARLEN[7:0],m_axi_port_r_ARSIZE[2:0],m_axi_port_r_ARBURST[1:0],m_axi_port_r_ARLOCK[1:0],m_axi_port_r_ARREGION[3:0],m_axi_port_r_ARCACHE[3:0],m_axi_port_r_ARPROT[2:0],m_axi_port_r_ARQOS[3:0],m_axi_port_r_ARVALID,m_axi_port_r_ARREADY,m_axi_port_r_RDATA[31:0],m_axi_port_r_RRESP[1:0],m_axi_port_r_RLAST,m_axi_port_r_RVALID,m_axi_port_r_RREADY" */;
  input ap_clk;
  input ap_rst_n;
