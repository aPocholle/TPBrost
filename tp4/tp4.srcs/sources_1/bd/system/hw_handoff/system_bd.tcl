...
proc create_root_design { parentCell } {
  ...
  # Create instance: interface_AXI_0, and set properties
  set block_name interface_AXI
  set block_cell_name interface_AXI_0
  if { [catch {set interface_AXI_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $interface_AXI_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins interface_AXI_0/S_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_10 [get_bd_pins clk_wiz_0/clk_10] [get_bd_pins timer_0/clk]
  connect_bd_net -net clk_wiz_0_clk_100 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_100] [get_bd_pins interface_AXI_0/S_AXI_ACLK] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net interface_AXI_0_pwm_1 [get_bd_ports pwm_1] [get_bd_pins interface_AXI_0/pwm_1]
  connect_bd_net -net interface_AXI_0_pwm_2 [get_bd_ports pwm_2] [get_bd_pins interface_AXI_0/pwm_2]
  connect_bd_net -net interface_AXI_0_pwm_3 [get_bd_ports pwm_3] [get_bd_pins interface_AXI_0/pwm_3]
  connect_bd_net -net interface_AXI_0_pwm_4 [get_bd_ports pwm_4] [get_bd_pins interface_AXI_0/pwm_4]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins interface_AXI_0/S_AXI_ARESETN] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  ...
  connect_bd_net -net timer_0_cpt [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins timer_0/cpt]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs interface_AXI_0/S_AXI/reg0] -force
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs interface_AXI_0/S_AXI/reg0] -force
