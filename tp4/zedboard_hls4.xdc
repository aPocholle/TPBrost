...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y9 [get_ports {clk_in1}];  # "GCLK"
...
#set_property PACKAGE_PIN AA9  [get_ports {tx}];  # "JA4"
...
# User LEDs - Bank 33
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN T22 [get_ports {pwm_1}];  # "LD0"
set_property PACKAGE_PIN T21 [get_ports {pwm_2}];  # "LD1"
set_property PACKAGE_PIN U22 [get_ports {pwm_3}];  # "LD2"
set_property PACKAGE_PIN U21 [get_ports {pwm_4}];  # "LD3"
