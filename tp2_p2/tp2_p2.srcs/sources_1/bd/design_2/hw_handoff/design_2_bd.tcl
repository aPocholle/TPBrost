...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net incrust_0_m_axis_video [get_bd_intf_pins incrust_0/m_axis_video] [get_bd_intf_pins video_ctrl/video_in]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins im_load_mm_0/s_axi_AXILiteS] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins processing_system7_0/S_AXI_HP0] [get_bd_intf_pins smartconnect_0/M03_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_100 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_100] [get_bd_pins im_load_mm_0/ap_clk] [get_bd_pins incrust_0/ap_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins video_ctrl/wr_clk]
  ...
  connect_bd_net -net video_ctrl_dout [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins im_load_mm_0/ap_rst_n] [get_bd_pins incrust_0/ap_rst_n] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins video_ctrl/peripheral_aresetn]
