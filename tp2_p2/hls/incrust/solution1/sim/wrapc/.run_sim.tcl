...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "incrust.autotvin.dat"
	set constFileTvOut       "incrust.autotvout.dat"
	set constFileHdlTvIn     "incrust.autohdltvin.dat"
	set constFileHdlTvOut    "incrust.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
