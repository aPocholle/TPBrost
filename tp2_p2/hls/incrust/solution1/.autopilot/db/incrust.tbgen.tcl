...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_video_V_data_V_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_video_V_keep_V_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_video_V_strb_V_U", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_video_V_user_V_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_video_V_last_V_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_video_V_id_V_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_s_axis_video_V_dest_V_U", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	incrust {
		...
		m_axis_video_V_data_V {Type O LastRead -1 FirstWrite 4}
		m_axis_video_V_keep_V {Type O LastRead -1 FirstWrite 4}
		m_axis_video_V_strb_V {Type O LastRead -1 FirstWrite 4}
		m_axis_video_V_user_V {Type O LastRead -1 FirstWrite 4}
		m_axis_video_V_last_V {Type O LastRead -1 FirstWrite 4}
		m_axis_video_V_id_V {Type O LastRead -1 FirstWrite 4}
		m_axis_video_V_dest_V {Type O LastRead -1 FirstWrite 4}
