...
set C_modelName {ov7670_if}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 8 unused {axi_master 0}  }
	{ video_in_V int 8 unused {fifo 0}  }
	{ vsync_V int 1 unused  }
	{ href_V int 1 unused  }
	{ mem_ddr_V int 32 unused  }
	{ hsize_in int 32 unused  }
	{ vsize_in int 32 unused  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "mem_ddr.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "mem_ddr_V"},"cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "video_in_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "video_in.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"cArray": [{"low" : 0,"up" : 99,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "mem_ddr_V", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ video_in_V_dout sc_in sc_lv 8 signal 1 } 
	{ video_in_V_empty_n sc_in sc_logic 1 signal 1 } 
	{ video_in_V_read sc_out sc_logic 1 signal 1 } 
	{ vsync_V sc_in sc_lv 1 signal 2 } 
	{ href_V sc_in sc_lv 1 signal 3 } 
	{ mem_ddr_V sc_in sc_lv 32 signal 4 } 
	{ hsize_in sc_in sc_lv 32 signal 5 } 
	{ vsize_in sc_in sc_lv 32 signal 6 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "video_in_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "video_in_V", "role": "dout" }} , 
 	{ "name": "video_in_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "video_in_V", "role": "empty_n" }} , 
 	{ "name": "video_in_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "video_in_V", "role": "read" }} , 
 	...
 	{ "name": "mem_ddr_V", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "mem_ddr_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "video_in_V", "Type" : "Fifo", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	ov7670_if {
		...
		video_in_V {Type I LastRead -1 FirstWrite -1}
		vsync_V {Type I LastRead -1 FirstWrite -1}
		href_V {Type I LastRead -1 FirstWrite -1}
		mem_ddr_V {Type I LastRead -1 FirstWrite -1}
		hsize_in {Type I LastRead -1 FirstWrite -1}
		vsize_in {Type I LastRead -1 FirstWrite -1}}}
...
set Spec2ImplPortList { 
	...
	video_in_V { ap_fifo {  { video_in_V_dout fifo_data 0 8 }  { video_in_V_empty_n fifo_status 0 1 }  { video_in_V_read fifo_update 1 1 } } }
	vsync_V { ap_none {  { vsync_V in_data 0 1 } } }
	href_V { ap_none {  { href_V in_data 0 1 } } }
	mem_ddr_V { ap_none {  { mem_ddr_V in_data 0 32 } } }
...
set fifoSchedulingInfoList { 
	video_in_V { fifo_read 0 no_conditional }
}
