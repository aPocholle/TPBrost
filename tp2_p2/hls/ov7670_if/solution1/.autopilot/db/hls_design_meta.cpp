...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("video_in_V_dout", 8, hls_in, 1, "ap_fifo", "fifo_data", 0),
	Port_Property("video_in_V_empty_n", 1, hls_in, 1, "ap_fifo", "fifo_status", 0),
	Port_Property("video_in_V_read", 1, hls_out, 1, "ap_fifo", "fifo_update", 0),
	Port_Property("vsync_V", 1, hls_in, 2, "ap_none", "in_data", 1),
	Port_Property("href_V", 1, hls_in, 3, "ap_none", "in_data", 1),
	Port_Property("mem_ddr_V", 32, hls_in, 4, "ap_none", "in_data", 1),
	Port_Property("hsize_in", 32, hls_in, 5, "ap_none", "in_data", 1),
	Port_Property("vsize_in", 32, hls_in, 6, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "ov7670_if";
