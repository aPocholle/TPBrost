...
reg   [9:0] p_src_rows_V_read_reg_158;
reg    ap_block_state1;
reg   [10:0] p_src_cols_V_read_reg_163;
...
always @ (*) begin
    ap_block_state1_ignore_call10 = ((real_start == 1'b0) | (p_src_cols_V_empty_n == 1'b0) | (p_src_rows_V_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end
