...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln126_reg_272 == 1'd0) & (video_out_TREADY_int == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0)));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln126_reg_272_pp0_iter1_reg == 1'd0) & (video_out_TREADY_int == 1'b0));
end
...
assign axi_last_V_fu_230_p2 = ((t_V_3_reg_190 == 10'd639) ? 1'b1 : 1'b0);

assign i_V_fu_212_p2 = (t_V_reg_179 + 9'd1);

assign icmp_ln125_fu_206_p2 = ((t_V_reg_179 == 9'd480) ? 1'b1 : 1'b0);

assign icmp_ln126_fu_218_p2 = ((t_V_3_reg_190 == 10'd640) ? 1'b1 : 1'b0);

assign j_V_fu_224_p2 = (t_V_3_reg_190 + 10'd1);

assign video_out_TDATA_int = {{{img_data_stream_2_V_dout}, {img_data_stream_1_V_dout}}, {img_data_stream_0_V_dout}};
