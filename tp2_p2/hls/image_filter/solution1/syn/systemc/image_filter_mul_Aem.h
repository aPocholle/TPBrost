...
// ==============================================================
#ifndef __image_filter_mul_Aem__HH__
#define __image_filter_mul_Aem__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mul_Aem) {
    ...
    SC_CTOR(image_filter_mul_Aem):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
