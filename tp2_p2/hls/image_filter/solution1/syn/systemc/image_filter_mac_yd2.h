...
// ==============================================================
#ifndef __image_filter_mac_yd2__HH__
#define __image_filter_mac_yd2__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_yd2) {
    ...
    SC_CTOR(image_filter_mac_yd2):  simcore_mac_7_U ("simcore_mac_7_U") {
