...
struct GaussianBlur : public sc_module {
    ...
    sc_signal< sc_lv<10> > p_src_rows_V_read_reg_158;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<11> > p_src_cols_V_read_reg_163;
    sc_signal< sc_logic > grp_Filter2D_fu_138_ap_start;
    sc_signal< sc_logic > grp_Filter2D_fu_138_ap_done;
    sc_signal< sc_logic > grp_Filter2D_fu_138_ap_idle;
    sc_signal< sc_logic > grp_Filter2D_fu_138_ap_ready;
    sc_signal< sc_logic > grp_Filter2D_fu_138_p_src_data_stream_0_V_read;
    sc_signal< sc_logic > grp_Filter2D_fu_138_p_src_data_stream_1_V_read;
    sc_signal< sc_logic > grp_Filter2D_fu_138_p_src_data_stream_2_V_read;
    sc_signal< sc_lv<8> > grp_Filter2D_fu_138_p_dst_data_stream_0_V_din;
    sc_signal< sc_logic > grp_Filter2D_fu_138_p_dst_data_stream_0_V_write;
    sc_signal< sc_lv<8> > grp_Filter2D_fu_138_p_dst_data_stream_1_V_din;
    sc_signal< sc_logic > grp_Filter2D_fu_138_p_dst_data_stream_1_V_write;
    sc_signal< sc_lv<8> > grp_Filter2D_fu_138_p_dst_data_stream_2_V_din;
    sc_signal< sc_logic > grp_Filter2D_fu_138_p_dst_data_stream_2_V_write;
    sc_signal< sc_logic > grp_Filter2D_fu_138_ap_start_reg;
    ...
    void thread_grp_Filter2D_fu_138_ap_start();
