...
// ==============================================================
#ifndef __image_filter_mac_sc4__HH__
#define __image_filter_mac_sc4__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_sc4) {
    ...
    SC_CTOR(image_filter_mac_sc4):  simcore_mac_1_U ("simcore_mac_1_U") {
