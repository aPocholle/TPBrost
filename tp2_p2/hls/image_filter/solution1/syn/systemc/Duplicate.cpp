...
const sc_lv<9> Duplicate::ap_const_lv9_1E0 = "111100000";
const sc_lv<9> Duplicate::ap_const_lv9_1 = "1";
const sc_lv<10> Duplicate::ap_const_lv10_280 = "1010000000";
...
Duplicate::Duplicate(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sc_trace(mVcdFile, t_V_6_reg_257, "t_V_6_reg_257");
...
void Duplicate::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_pp0_stage0.read()) && 
        ...
        t_V_6_reg_257 = j_V_fu_286_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(ap_const_lv1_0, icmp_ln1557_fu_268_p2.read()))) {
...
void Duplicate::thread_ap_block_state4_pp0_stage0_iter1() {
  ...
  esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_0_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_301.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_1_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_301.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, src_data_stream_2_V_empty_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_301.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_0_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_301.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_1_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_301.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst1_data_stream_2_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_301.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst2_data_stream_0_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_301.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst2_data_stream_1_V_full_n.read())) || (esl_seteq<1,1,1>(icmp_ln1558_reg_301.read(), ap_const_lv1_0) && 
  esl_seteq<1,1,1>(ap_const_logic_0, dst2_data_stream_2_V_full_n.read())));
}
...
void Duplicate::thread_i_V_fu_274_p2() {
...
void Duplicate::thread_icmp_ln1557_fu_268_p2() {
    icmp_ln1557_fu_268_p2 = (!t_V_reg_246.read().is_01() || !ap_const_lv9_1E0.is_01())? sc_lv<1>(): sc_lv<1>(t_V_reg_246.read() == ap_const_lv9_1E0);
}

void Duplicate::thread_icmp_ln1558_fu_280_p2() {
    icmp_ln1558_fu_280_p2 = (!t_V_6_reg_257.read().is_01() || !ap_const_lv10_280.is_01())? sc_lv<1>(): sc_lv<1>(t_V_6_reg_257.read() == ap_const_lv10_280);
}
...
void Duplicate::thread_j_V_fu_286_p2() {
    j_V_fu_286_p2 = (!t_V_6_reg_257.read().is_01() || !ap_const_lv10_1.is_01())? sc_lv<10>(): (sc_biguint<10>(t_V_6_reg_257.read()) + sc_biguint<10>(ap_const_lv10_1));
}
