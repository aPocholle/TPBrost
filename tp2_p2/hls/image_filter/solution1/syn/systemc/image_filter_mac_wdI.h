...
// ==============================================================
#ifndef __image_filter_mac_wdI__HH__
#define __image_filter_mac_wdI__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_wdI) {
    ...
    SC_CTOR(image_filter_mac_wdI):  simcore_mac_5_U ("simcore_mac_5_U") {
