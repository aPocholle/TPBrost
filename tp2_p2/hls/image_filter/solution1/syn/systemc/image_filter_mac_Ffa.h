...
// ==============================================================
#ifndef __image_filter_mac_Ffa__HH__
#define __image_filter_mac_Ffa__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_Ffa) {
    ...
    SC_CTOR(image_filter_mac_Ffa):  simcore_mac_11_U ("simcore_mac_11_U") {
