...
// ==============================================================
#ifndef __image_filter_mac_DeQ__HH__
#define __image_filter_mac_DeQ__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_DeQ) {
    ...
    SC_CTOR(image_filter_mac_DeQ):  simcore_mac_9_U ("simcore_mac_9_U") {
