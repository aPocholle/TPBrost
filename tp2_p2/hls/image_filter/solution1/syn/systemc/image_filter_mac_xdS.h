...
// ==============================================================
#ifndef __image_filter_mac_xdS__HH__
#define __image_filter_mac_xdS__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_xdS) {
    ...
    SC_CTOR(image_filter_mac_xdS):  simcore_mac_6_U ("simcore_mac_6_U") {
