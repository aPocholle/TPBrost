...
// ==============================================================
#ifndef __image_filter_mac_vdy__HH__
#define __image_filter_mac_vdy__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_vdy) {
    ...
    SC_CTOR(image_filter_mac_vdy):  simcore_mac_4_U ("simcore_mac_4_U") {
