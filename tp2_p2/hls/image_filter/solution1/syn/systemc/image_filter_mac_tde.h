...
// ==============================================================
#ifndef __image_filter_mac_tde__HH__
#define __image_filter_mac_tde__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_tde) {
    ...
    SC_CTOR(image_filter_mac_tde):  simcore_mac_2_U ("simcore_mac_2_U") {
