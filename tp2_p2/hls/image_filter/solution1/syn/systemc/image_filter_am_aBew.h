...
// ==============================================================
#ifndef __image_filter_am_aBew__HH__
#define __image_filter_am_aBew__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_am_aBew) {
    ...
    SC_CTOR(image_filter_am_aBew):  simcore_am_0_U ("simcore_am_0_U") {
