...
// ==============================================================
#ifndef __image_filter_mac_Ee0__HH__
#define __image_filter_mac_Ee0__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_Ee0) {
    ...
    SC_CTOR(image_filter_mac_Ee0):  simcore_mac_10_U ("simcore_mac_10_U") {
