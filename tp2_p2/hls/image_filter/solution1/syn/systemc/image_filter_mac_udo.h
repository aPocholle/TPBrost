...
// ==============================================================
#ifndef __image_filter_mac_udo__HH__
#define __image_filter_mac_udo__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_udo) {
    ...
    SC_CTOR(image_filter_mac_udo):  simcore_mac_3_U ("simcore_mac_3_U") {
