...
reg   [31:0] start_y_read_reg_355;
wire    ap_CS_fsm_state1;
reg   [31:0] start_x_read_reg_360;
wire   [31:0] add_ln24_fu_182_p2;
reg   [31:0] add_ln24_reg_365;
wire   [31:0] add_ln24_1_fu_188_p2;
reg   [31:0] add_ln24_1_reg_370;
wire   [8:0] i_fu_209_p2;
reg   [8:0] i_reg_378;
wire    ap_CS_fsm_state2;
wire    regslice_both_m_axis_video_V_data_V_U_apdone_blk;
wire   [0:0] icmp_ln24_fu_215_p2;
reg   [0:0] icmp_ln24_reg_383;
wire   [0:0] icmp_ln18_fu_203_p2;
wire   [0:0] icmp_ln24_1_fu_220_p2;
reg   [0:0] icmp_ln24_1_reg_388;
wire   [9:0] j_fu_235_p2;
reg   [9:0] j_reg_396;
wire    ap_CS_fsm_state3;
wire   [0:0] and_ln24_fu_277_p2;
reg   [0:0] and_ln24_reg_401;
wire   [0:0] icmp_ln20_fu_229_p2;
reg   [8:0] i_0_reg_160;
reg   [9:0] j_0_reg_171;
wire  signed [63:0] sext_ln25_fu_282_p1;
reg   [31:0] pixel_1_fu_88;
wire   [31:0] pixel_2_fu_293_p3;
wire   [31:0] zext_ln18_fu_199_p1;
wire   [31:0] zext_ln20_fu_225_p1;
wire   [0:0] icmp_ln24_3_fu_249_p2;
wire   [0:0] icmp_ln24_2_fu_244_p2;
wire   [0:0] or_ln24_fu_260_p2;
wire   [0:0] xor_ln24_1_fu_254_p2;
wire   [0:0] or_ln24_1_fu_265_p2;
wire   [0:0] xor_ln24_fu_271_p2;
wire  signed [31:0] sext_ln25_fu_282_p0;
wire  signed [31:0] pixel_fu_287_p0;
wire   [31:0] pixel_fu_287_p2;
wire  signed [31:0] pixel_2_fu_293_p2;
reg   [4:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln20_fu_229_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln18_fu_203_p2 == 1'd0) & (regslice_both_m_axis_video_V_data_V_U_apdone_blk == 1'b0))) begin
        j_0_reg_171 <= 10'd0;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln20_fu_229_p2 == 1'd0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state2 : begin
            if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln18_fu_203_p2 == 1'd1) & (regslice_both_m_axis_video_V_data_V_U_apdone_blk == 1'b0))) begin
                ap_NS_fsm = ap_ST_fsm_state1;
            end else if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln18_fu_203_p2 == 1'd0) & (regslice_both_m_axis_video_V_data_V_U_apdone_blk == 1'b0))) begin
...
assign add_ln24_1_fu_188_p2 = (start_y + 32'd69);

assign add_ln24_fu_182_p2 = (start_x + 32'd148);

assign and_ln24_fu_277_p2 = (xor_ln24_fu_271_p2 & icmp_ln24_1_reg_388);
...
assign icmp_ln18_fu_203_p2 = ((i_0_reg_160 == 9'd480) ? 1'b1 : 1'b0);

assign icmp_ln20_fu_229_p2 = ((j_0_reg_171 == 10'd640) ? 1'b1 : 1'b0);

assign icmp_ln24_1_fu_220_p2 = (($signed(zext_ln18_fu_199_p1) < $signed(add_ln24_1_reg_370)) ? 1'b1 : 1'b0);

assign icmp_ln24_2_fu_244_p2 = (($signed(zext_ln20_fu_225_p1) < $signed(start_x_read_reg_360)) ? 1'b1 : 1'b0);

assign icmp_ln24_3_fu_249_p2 = (($signed(zext_ln20_fu_225_p1) < $signed(add_ln24_reg_365)) ? 1'b1 : 1'b0);

assign icmp_ln24_fu_215_p2 = (($signed(zext_ln18_fu_199_p1) < $signed(start_y_read_reg_355)) ? 1'b1 : 1'b0);

assign im_incrust_V_address0 = sext_ln25_fu_282_p1;

assign j_fu_235_p2 = (j_0_reg_171 + 10'd1);

assign m_axis_video_TDATA_int = ((and_ln24_reg_401[0:0] === 1'b1) ? im_incrust_V_q0 : s_axis_video_TDATA_int);

assign m_axis_video_TVALID = regslice_both_m_axis_video_V_data_V_U_vld_out;

assign or_ln24_1_fu_265_p2 = (xor_ln24_1_fu_254_p2 | or_ln24_fu_260_p2);

assign or_ln24_fu_260_p2 = (icmp_ln24_reg_383 | icmp_ln24_2_fu_244_p2);

assign pixel_2_fu_293_p2 = pixel_1_fu_88;

assign pixel_2_fu_293_p3 = ((and_ln24_fu_277_p2[0:0] === 1'b1) ? pixel_fu_287_p2 : pixel_2_fu_293_p2);

assign pixel_fu_287_p0 = pixel_1_fu_88;

assign pixel_fu_287_p2 = ($signed(pixel_fu_287_p0) + $signed(32'd1));

assign sext_ln25_fu_282_p0 = pixel_1_fu_88;

assign sext_ln25_fu_282_p1 = sext_ln25_fu_282_p0;

assign xor_ln24_1_fu_254_p2 = (icmp_ln24_3_fu_249_p2 ^ 1'd1);

assign xor_ln24_fu_271_p2 = (or_ln24_1_fu_265_p2 ^ 1'd1);

assign zext_ln18_fu_199_p1 = i_0_reg_160;

assign zext_ln20_fu_225_p1 = j_0_reg_171;
