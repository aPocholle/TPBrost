...
set C_modelName {video_crop}
set C_modelType { void 0 }
set C_modelArgList {
	{ mode_V int 1 unused  }
	{ s_axis_video_V_data_V int 8 unused {axi_s 0 ""  { s_axis_video Data } }  }
	{ s_axis_video_V_keep_V int 1 unused {axi_s 0 ""  { s_axis_video Keep } }  }
	{ s_axis_video_V_strb_V int 1 unused {axi_s 0 ""  { s_axis_video Strb } }  }
	{ s_axis_video_V_user_V int 1 unused {axi_s 0 ""  { s_axis_video User } }  }
	{ s_axis_video_V_last_V int 1 unused {axi_s 0 ""  { s_axis_video Last } }  }
	{ s_axis_video_V_id_V int 1 unused {axi_s 0 ""  { s_axis_video ID } }  }
	{ s_axis_video_V_dest_V int 1 unused {axi_s 0 ""  { s_axis_video Dest } }  }
...
set ArgLastReadFirstWriteLatency {
	video_crop {
		mode_V {Type I LastRead -1 FirstWrite -1}
