...
architecture behav of video_crop is 
    ...
    "video_crop,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=271,HLS_SYN_LUT=476,HLS_VERSION=2019_2}";
    ...
    signal icmp_ln13_reg_252 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal icmp_ln13_reg_252_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal indvar_flatten_reg_111 : STD_LOGIC_VECTOR (63 downto 0);
    signal i_0_reg_122 : STD_LOGIC_VECTOR (30 downto 0);
    signal val_assign_reg_133 : STD_LOGIC_VECTOR (30 downto 0);
    signal add_ln24_fu_144_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln24_reg_242 : STD_LOGIC_VECTOR (31 downto 0);
    signal bound_fu_158_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal bound_reg_247 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal add_ln13_fu_178_p2 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal select_ln13_1_fu_202_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal select_ln13_1_reg_261 : STD_LOGIC_VECTOR (30 downto 0);
    signal tmp_user_V_fu_216_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal video_data_V_fu_227_p1 : STD_LOGIC_VECTOR (7 downto 0);
    signal video_data_V_reg_276 : STD_LOGIC_VECTOR (7 downto 0);
    signal j_fu_231_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state2 : STD_LOGIC;
    signal ap_phi_mux_i_0_phi_fu_126_p4 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal bound_fu_158_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal bound_fu_158_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln16_fu_164_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln16_fu_168_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal select_ln13_fu_184_p3 : STD_LOGIC_VECTOR (30 downto 0);
    signal add_ln13_1_fu_196_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal or_ln19_fu_210_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal zext_ln13_fu_192_p1 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal bound_fu_158_p00 : STD_LOGIC_VECTOR (63 downto 0);
    signal bound_fu_158_p10 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln13_reg_252 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln13_fu_173_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    val_assign_reg_133_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln13_fu_173_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln13_fu_173_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, icmp_ln13_fu_173_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_CS_fsm_state5, regslice_both_m_axis_video_V_data_V_U_apdone_blk)
    begin
        case ap_CS_fsm is
    ...
    add_ln13_1_fu_196_p2 <= std_logic_vector(unsigned(ap_const_lv31_1) + unsigned(ap_phi_mux_i_0_phi_fu_126_p4));
    add_ln13_fu_178_p2 <= std_logic_vector(unsigned(indvar_flatten_reg_111) + unsigned(ap_const_lv64_1));
    add_ln24_fu_144_p2 <= std_logic_vector(unsigned(hsize_in) + unsigned(ap_const_lv32_FFFFFFFF));
    ...
    ap_block_state3_io_assign_proc : process(icmp_ln13_reg_252, m_axis_video_TREADY_int)
    begin
                ap_block_state3_io <= ((icmp_ln13_reg_252 = ap_const_lv1_0) and (m_axis_video_TREADY_int = ap_const_logic_0));
    end process;

        ap_block_state3_pp0_stage0_iter1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_state4_io_assign_proc : process(icmp_ln13_reg_252_pp0_iter1_reg, m_axis_video_TREADY_int)
    begin
                ap_block_state4_io <= ((icmp_ln13_reg_252_pp0_iter1_reg = ap_const_lv1_0) and (m_axis_video_TREADY_int = ap_const_logic_0));
    end process;

        ap_block_state4_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state2_assign_proc : process(icmp_ln13_fu_173_p2)
    begin
        if ((icmp_ln13_fu_173_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_i_0_phi_fu_126_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln13_reg_252, i_0_reg_122, select_ln13_1_reg_261)
    begin
        if (((icmp_ln13_reg_252 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    bound_fu_158_p0 <= bound_fu_158_p00(32 - 1 downto 0);
    bound_fu_158_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(hsize_in),64));
    bound_fu_158_p1 <= bound_fu_158_p10(32 - 1 downto 0);
    bound_fu_158_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(vsize_in),64));
    bound_fu_158_p2 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(bound_fu_158_p0) * unsigned(bound_fu_158_p1), 64));
    icmp_ln13_fu_173_p2 <= "1" when (indvar_flatten_reg_111 = bound_reg_247) else "0";
    icmp_ln16_fu_168_p2 <= "1" when (signed(zext_ln16_fu_164_p1) < signed(hsize_in)) else "0";
    j_fu_231_p2 <= std_logic_vector(unsigned(ap_const_lv31_1) + unsigned(select_ln13_fu_184_p3));

    m_axis_video_TDATA_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln13_reg_252, ap_enable_reg_pp0_iter2, icmp_ln13_reg_252_pp0_iter1_reg, m_axis_video_TREADY_int)
    begin
        if ((((icmp_ln13_reg_252_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((icmp_ln13_reg_252 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    m_axis_video_TVALID_int_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln13_reg_252, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (icmp_ln13_reg_252 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    or_ln19_fu_210_p2 <= (select_ln13_fu_184_p3 or select_ln13_1_fu_202_p3);
    ...
    select_ln13_1_fu_202_p3 <= 
        ap_phi_mux_i_0_phi_fu_126_p4 when (icmp_ln16_fu_168_p2(0) = '1') else 
        add_ln13_1_fu_196_p2;
    select_ln13_fu_184_p3 <= 
        val_assign_reg_133 when (icmp_ln16_fu_168_p2(0) = '1') else 
        ap_const_lv31_0;
    tmp_last_V_fu_222_p2 <= "1" when (zext_ln13_fu_192_p1 = add_ln24_reg_242) else "0";
    tmp_user_V_fu_216_p2 <= "1" when (or_ln19_fu_210_p2 = ap_const_lv31_0) else "0";
    video_data_V_fu_227_p1 <= select_ln13_fu_184_p3(8 - 1 downto 0);
    zext_ln13_fu_192_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(select_ln13_fu_184_p3),32));
    zext_ln16_fu_164_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(val_assign_reg_133),32));
end behav;
