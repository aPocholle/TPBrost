...
set C_modelArgList {
	...
	{ mem_ddr_V int 32 regular  }
	{ hsize_in int 32 regular  }
	{ vsize_in int 32 regular  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":7,"cElement": [{"cName": "mem_ddr.V","cData": "uint8","bit_use": { "low": 0,"up": 7},"offset": { "type": "dynamic","port_name": "mem_ddr_V"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ mem_ddr_V sc_in sc_lv 32 signal 8 } 
	{ hsize_in sc_in sc_lv 32 signal 9 } 
	{ vsize_in sc_in sc_lv 32 signal 10 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.axis_to_aximm_gmem_m_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mem_locale_V_U", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	axis_to_aximm {
		gmem {Type O LastRead 5 FirstWrite 6}
