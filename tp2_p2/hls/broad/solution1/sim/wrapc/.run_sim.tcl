...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "broad.autotvin.dat"
	set constFileTvOut       "broad.autotvout.dat"
	set constFileHdlTvIn     "broad.autohdltvin.dat"
	set constFileHdlTvOut    "broad.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
