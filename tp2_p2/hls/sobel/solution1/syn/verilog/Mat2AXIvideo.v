...
reg   [0:0] icmp_ln126_reg_272;
reg    OUTPUT_STREAM_TDATA_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln126_reg_272_pp0_iter1_reg;
reg   [31:0] t_V_1_reg_175;
reg   [31:0] rows_V_reg_248;
reg    ap_block_state1;
reg   [31:0] cols_V_reg_253;
wire   [32:0] ret_V_fu_190_p2;
reg   [32:0] ret_V_reg_258;
wire   [0:0] icmp_ln125_fu_201_p2;
wire    ap_CS_fsm_state2;
wire    regslice_both_AXI_video_strm_V_data_V_U_apdone_blk;
wire   [31:0] i_V_fu_206_p2;
...
wire   [32:0] zext_ln1354_fu_186_p1;
wire   [32:0] zext_ln879_fu_223_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln125_fu_201_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((icmp_ln125_fu_201_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln126_reg_272 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((icmp_ln126_reg_272_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln126_reg_272 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((icmp_ln125_fu_201_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2) & (regslice_both_AXI_video_strm_V_data_V_U_apdone_blk == 1'b0))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((icmp_ln126_reg_272 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln126_fu_212_p2 == 1'd1)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln126_fu_212_p2 == 1'd1)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state5_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & ((1'b1 == ap_block_state4_io) | ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_V_empty_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state4_io = ((icmp_ln126_reg_272 == 1'd0) & (1'b0 == OUTPUT_STREAM_TREADY_int));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = ((icmp_ln126_reg_272 == 1'd0) & (img_data_stream_V_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state5_io = ((icmp_ln126_reg_272_pp0_iter1_reg == 1'd0) & (1'b0 == OUTPUT_STREAM_TREADY_int));
end
...
assign axi_last_V_fu_227_p2 = ((zext_ln879_fu_223_p1 == ret_V_reg_258) ? 1'b1 : 1'b0);

assign i_V_fu_206_p2 = (t_V_reg_164 + 32'd1);

assign icmp_ln125_fu_201_p2 = ((t_V_reg_164 == rows_V_reg_248) ? 1'b1 : 1'b0);

assign icmp_ln126_fu_212_p2 = ((t_V_1_reg_175 == cols_V_reg_253) ? 1'b1 : 1'b0);

assign j_V_fu_217_p2 = (t_V_1_reg_175 + 32'd1);

assign ret_V_fu_190_p2 = ($signed(zext_ln1354_fu_186_p1) + $signed(33'd8589934591));

assign zext_ln1354_fu_186_p1 = img_cols_V_dout;

assign zext_ln879_fu_223_p1 = t_V_1_reg_175;
