...
architecture behav of AXIvideo2Mat is 
    ...
    signal icmp_ln73_fu_361_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal or_ln76_fu_375_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal icmp_ln73_reg_425 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal t_V_3_reg_248 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_data_V_reg_396 : STD_LOGIC_VECTOR (7 downto 0);
    signal tmp_last_V_reg_404 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln71_fu_350_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal i_V_fu_355_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_V_reg_420 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_predicate_op63_read_state5 : BOOLEAN;
    signal ap_block_state5_pp1_stage0_iter0 : BOOLEAN;
    signal ap_block_state6_pp1_stage0_iter1 : BOOLEAN;
    signal ap_block_pp1_stage0_11001 : BOOLEAN;
    signal j_V_fu_366_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal INPUT_STREAM_TDATA_int : STD_LOGIC_VECTOR (7 downto 0);
    ...
    signal INPUT_STREAM_TKEEP_int : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal INPUT_STREAM_TSTRB_int : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln73_reg_425 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif ((not(((eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_0 = INPUT_STREAM_TVALID_int))) and (eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_1 = ap_condition_184)) then
                if (((or_ln76_fu_375_p2 = ap_const_lv1_1) and (icmp_ln73_fu_361_p2 = ap_const_lv1_0))) then 
                    axi_last_V_2_i_reg_271 <= ap_phi_mux_eol_phi_fu_229_p4;
                elsif (((or_ln76_fu_375_p2 = ap_const_lv1_0) and (icmp_ln73_fu_361_p2 = ap_const_lv1_0))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln73_fu_361_p2 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
    ...
    t_V_3_reg_248_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln73_fu_361_p2 = ap_const_lv1_0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
                t_V_3_reg_248 <= j_V_fu_366_p2;
            elsif (((icmp_ln71_fu_350_p2 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state4))) then 
                t_V_3_reg_248 <= ap_const_lv32_0;
            end if; 
        end if;
    end process;
    ...
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((tmp_user_V_fu_341_p1 = ap_const_lv1_0) and (ap_const_logic_1 = INPUT_STREAM_TVALID_int) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state2;
                elsif (((ap_const_logic_1 = INPUT_STREAM_TVALID_int) and (tmp_user_V_fu_341_p1 = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
            ...
            when ap_ST_fsm_pp1_stage0 => 
                if (not(((icmp_ln73_fu_361_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone)))) then
                    ap_NS_fsm <= ap_ST_fsm_pp1_stage0;
                elsif (((icmp_ln73_fu_361_p2 = ap_const_lv1_1) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_subdone))) then
            ...
            when ap_ST_fsm_state8 => 
                if ((not(((eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_0 = INPUT_STREAM_TVALID_int))) and (eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8))) then
                    ap_NS_fsm <= ap_ST_fsm_state8;
                elsif ((not(((eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_0 = INPUT_STREAM_TVALID_int))) and (ap_const_logic_1 = ap_CS_fsm_state8) and (ap_phi_mux_eol_2_i_phi_fu_324_p4 = ap_const_lv1_1))) then
    ...
    INPUT_STREAM_TDATA_blk_n_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_block_pp1_stage0, icmp_ln73_fu_361_p2, or_ln76_fu_375_p2, ap_CS_fsm_state8, eol_2_i_reg_321, INPUT_STREAM_TVALID_int)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or ((or_ln76_fu_375_p2 = ap_const_lv1_0) and (icmp_ln73_fu_361_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0)) or ((eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    INPUT_STREAM_TREADY_int_assign_proc : process(ap_CS_fsm_state2, ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter0, ap_CS_fsm_state8, ap_predicate_op63_read_state5, ap_block_pp1_stage0_11001, eol_2_i_reg_321, INPUT_STREAM_TVALID_int)
    begin
        if ((((ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_predicate_op63_read_state5 = ap_const_boolean_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001)) or ((ap_const_logic_1 = INPUT_STREAM_TVALID_int) and (ap_const_logic_1 = ap_CS_fsm_state2)) or (not(((eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_0 = INPUT_STREAM_TVALID_int))) and (eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_state8)))) then 
    ...
    ap_block_pp1_stage0_01001_assign_proc : process(img_data_stream_V_full_n, ap_enable_reg_pp1_iter0, ap_enable_reg_pp1_iter1, icmp_ln73_reg_425, ap_predicate_op63_read_state5, INPUT_STREAM_TVALID_int)
    begin
                ap_block_pp1_stage0_01001 <= (((ap_const_logic_0 = INPUT_STREAM_TVALID_int) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_predicate_op63_read_state5 = ap_const_boolean_1)) or ((icmp_ln73_reg_425 = ap_const_lv1_0) and (img_data_stream_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp1_stage0_11001_assign_proc : process(img_data_stream_V_full_n, ap_enable_reg_pp1_iter0, ap_enable_reg_pp1_iter1, icmp_ln73_reg_425, ap_predicate_op63_read_state5, INPUT_STREAM_TVALID_int)
    begin
                ap_block_pp1_stage0_11001 <= (((ap_const_logic_0 = INPUT_STREAM_TVALID_int) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_predicate_op63_read_state5 = ap_const_boolean_1)) or ((icmp_ln73_reg_425 = ap_const_lv1_0) and (img_data_stream_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp1_stage0_subdone_assign_proc : process(img_data_stream_V_full_n, ap_enable_reg_pp1_iter0, ap_enable_reg_pp1_iter1, icmp_ln73_reg_425, ap_predicate_op63_read_state5, INPUT_STREAM_TVALID_int)
    begin
                ap_block_pp1_stage0_subdone <= (((ap_const_logic_0 = INPUT_STREAM_TVALID_int) and (ap_enable_reg_pp1_iter0 = ap_const_logic_1) and (ap_predicate_op63_read_state5 = ap_const_boolean_1)) or ((icmp_ln73_reg_425 = ap_const_lv1_0) and (img_data_stream_V_full_n = ap_const_logic_0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1)));
    end process;
    ...
    ap_block_state5_pp1_stage0_iter0_assign_proc : process(ap_predicate_op63_read_state5, INPUT_STREAM_TVALID_int)
    begin
                ap_block_state5_pp1_stage0_iter0 <= ((ap_const_logic_0 = INPUT_STREAM_TVALID_int) and (ap_predicate_op63_read_state5 = ap_const_boolean_1));
    end process;


    ap_block_state6_pp1_stage0_iter1_assign_proc : process(img_data_stream_V_full_n, icmp_ln73_reg_425)
    begin
                ap_block_state6_pp1_stage0_iter1 <= ((icmp_ln73_reg_425 = ap_const_lv1_0) and (img_data_stream_V_full_n = ap_const_logic_0));
    end process;


    ap_block_state8_assign_proc : process(eol_2_i_reg_321, INPUT_STREAM_TVALID_int)
    begin
                ap_block_state8 <= ((eol_2_i_reg_321 = ap_const_lv1_0) and (ap_const_logic_0 = INPUT_STREAM_TVALID_int));
    end process;
    ...
    ap_condition_pp1_exit_iter0_state5_assign_proc : process(icmp_ln73_fu_361_p2)
    begin
        if ((icmp_ln73_fu_361_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_axi_data_V_1_i_phi_fu_240_p4_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln73_reg_425, axi_data_V_1_i_reg_237, p_Val2_s_reg_284)
    begin
        if (((icmp_ln73_reg_425 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1))) then 
    ...
    ap_phi_mux_eol_0_i_phi_fu_263_p4_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln73_reg_425, eol_0_i_reg_259, axi_last_V_2_i_reg_271)
    begin
        if (((icmp_ln73_reg_425 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1))) then 
    ...
    ap_phi_mux_eol_phi_fu_229_p4_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln73_reg_425, eol_reg_226, axi_last_V_2_i_reg_271)
    begin
        if (((icmp_ln73_reg_425 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1))) then 
    ...
    ap_predicate_op63_read_state5_assign_proc : process(icmp_ln73_fu_361_p2, or_ln76_fu_375_p2)
    begin
                ap_predicate_op63_read_state5 <= ((or_ln76_fu_375_p2 = ap_const_lv1_0) and (icmp_ln73_fu_361_p2 = ap_const_lv1_0));
    end process;

    ap_ready <= internal_ap_ready;
    i_V_fu_355_p2 <= std_logic_vector(unsigned(t_V_reg_215) + unsigned(ap_const_lv32_1));
    icmp_ln71_fu_350_p2 <= "1" when (t_V_reg_215 = rows_V_reg_386) else "0";
    icmp_ln73_fu_361_p2 <= "1" when (t_V_3_reg_248 = cols_V_reg_391) else "0";
    ...
    img_data_stream_V_blk_n_assign_proc : process(img_data_stream_V_full_n, ap_CS_fsm_pp1_stage0, ap_block_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln73_reg_425)
    begin
        if (((icmp_ln73_reg_425 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp1_stage0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1))) then 
    ...
    img_data_stream_V_write_assign_proc : process(ap_CS_fsm_pp1_stage0, ap_enable_reg_pp1_iter1, icmp_ln73_reg_425, ap_block_pp1_stage0_11001)
    begin
        if (((icmp_ln73_reg_425 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp1_stage0) and (ap_enable_reg_pp1_iter1 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp1_stage0_11001))) then 
    ...
    j_V_fu_366_p2 <= std_logic_vector(unsigned(t_V_3_reg_248) + unsigned(ap_const_lv32_1));
    or_ln76_fu_375_p2 <= (sof_1_i_fu_138 or ap_phi_mux_eol_0_i_phi_fu_263_p4);
    ...
    tmp_user_V_fu_341_p1 <= INPUT_STREAM_TUSER_int;
end behav;
